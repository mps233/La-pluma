/**
 * SVG Icon Components
 * Pure TypeScript icon components with gradient backgrounds
 * 
 * 图标分类：
 * 1. 主要功能图标（带渐变背景）
 * 2. 辅助功能图标（纯色）
...
const Icons = {
  ...
  Robot: () => (
    <svg className="w-6 h-6 brand-text" fill="none" stroke="currentColor" viewBox="0 0 24 24" strokeWidth={2}>
      <path strokeLinecap="round" strokeLinejoin="round" 
  ...
  // 战斗任务图标
  Target: () => (
    <div className="icon-well flex h-10 w-10 items-center justify-center rounded-2xl">
      <svg className="w-5 h-5 text-current" fill="none" stroke="currentColor" viewBox="0 0 24 24" strokeWidth={2}>
        <path strokeLinecap="round" strokeLinejoin="round" 
              d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z" />
      </svg>
    </div>
  ...
  Lightning: () => (
    <svg className="w-5 h-5 brand-text" fill="none" stroke="currentColor" viewBox="0 0 24 24" strokeWidth={2}>
      <path strokeLinecap="round" strokeLinejoin="round" 
  ...
  TrendingUp: ({ className = "w-5 h-5" }: IconProps) => (
    <svg className={className} fill="none" stroke="currentColor" viewBox="0 0 24 24" strokeWidth={2}>
      <path strokeLinecap="round" strokeLinejoin="round" 
